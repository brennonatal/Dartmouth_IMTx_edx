...
team 1 player 2, and so on). 
There is the same number of players on each side. You record the player weights as they are presented and calculate a total 
...
Example
Each team is composed of four players. Those of the first weigh 110, 113, 112, and 117kg, while those of the second weigh 106, 
102, 121, and 111kg. Team 1 weighs a total of 452kg whereas team 2 weighs a total of 440kg, giving team 1 an advantage.
...
int main(void)
{
    ...
    {
        printf("Team 1 has an advantage\nTotal weight for team 1: %d\nTotal weight for team 2: %d", totalWeight1, totalWeight2);
    }
    else
    {
